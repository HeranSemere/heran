    ...
    return (
        ...
        >
            ...
            {isHovered && <div className="carousel-content">
                ...
                <button className="carousel-button" style={{ float: 'left', border: 'solid 1px white', padding: '10px', marginLeft: '5px', marginTop: '15px', width: '70px' }} class="btn default">Code</button>
