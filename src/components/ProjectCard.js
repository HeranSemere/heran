    ...
    return (
        ...
        >
            ...
            {isHovered && <div className="carousel-content">
                ...
                <button className="carousel-button" onClick="window.location.href='https://github.com/HeranSemere/test';" style={{ float: 'left', border: 'solid 1px white', padding: '10px', marginLeft: '5px', marginTop: '15px', width: '70px', backgroundColor: 'transparent', color: 'white'}} class="btn default" >View</button>
                <button className="carousel-button" style={{ float: 'left', border: 'solid 1px white', padding: '10px', marginLeft: '5px', marginTop: '15px', width: '70px',  backgroundColor: 'transparent', color: 'white' }} class="btn default">Code</button>
